...
def build_chest(args, cfg) -> dict:
    ...
    assert_prevalence_fidelity(kept, label_cols, tol=args.tol)
...
def build_derm(args, cfg) -> dict:
    ...
    assert_no_group_leakage(kept, "patient_id")
    # melanoma is rare; allow a slightly looser absolute tolerance
    assert_prevalence_fidelity(kept, label_cols, tol=max(args.tol, 0.01))
